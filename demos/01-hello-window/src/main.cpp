...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "GLFW Triangle Example", NULL, NULL);
    if (window == NULL)
    {
    ...
    // Shader code (you need to create shader files and load them here)
    ...
    // Check for compile errors (similarly, do this for fragment shader)
    int success;
    char infoLog[512];
    ...
    // Check for compile errors (similarly, do this for vertex shader)
    ...
    // Don't forget to delete the shaders after linking
